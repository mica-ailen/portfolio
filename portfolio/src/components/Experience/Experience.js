  ...
  return (
    <div className='experience-page'>
        ...
        <div className='experience-items'>
          ...
          <li>Collaborating on Frontend and Backend teams (Developing APIs for the frontend and data storage in
              MongoDB)</li>
          <li>Translating Figma designs into code</li>
          <li>Tech Stack: React.js, JavaScript, Typescript, Node.js, Express.js, MongoDB, OpenAI API, CSS, Figma, Git</li>
          </ul>
          </div>
          <div className='experience-description'>
          ...
          <li>Tech Stack: React.js, JavaScript, Python CSS, Bootstrap, Figma, Strapi.js, Git and GitHub</li>
          </ul>
          </div>
        </div>
    </div>
